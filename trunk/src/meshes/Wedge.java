...
public class Wedge extends Mesh
{
    ...
    public void updateGeometry(Orientation orientation, Vector3f bounds, boolean isExtruded)
    {
        ...
        } else
        {
            ...
            Vector3f normal1 = new Vector3f(p1.y - p0.y, p0.x - p1.x, 0).normalizeLocal();
            Vector3f normal2 = new Vector3f(p2.y - p1.y, p1.x - p2.x, 0).normalizeLocal();
            Vector3f normal3 = new Vector3f(p0.y - p2.y, p2.x - p0.x, 0).normalizeLocal();
